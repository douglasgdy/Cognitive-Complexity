                ...
                @"for(int i = 0; i < 10 && i > 1; i++)
{
    int x = 1;
        ...
        [Test]
        public void Calculate_BooleanAssignmentOfAndOperator_Return2()
        {
                ...
                @"while(b1 && b2)
{
    int x = 1;
        ...
        [Test]
        public void Calculate_WhileLoopWithAndOperatorWithOrOperator_Return4()
        {
            const string method =
                @"while(b1 && b2 || b3)
{
    int x = 1;
        ...
        [Test]
        public void Calculate_WhileLoopWithAndOperatorWithinParenthesisWithOrOperator_Return4()
        {
            const string method =
                @"while((b1 && b2) || b3)
{
...
@"switch (sf)
{
    ...
    default: break;
        ...
        [Test]
        public void Calculate_TernaryOperator_Return3()
        {
            const string method =
@"int x = 1 > 0 ? 1 : 0";
...
var p1 = new Person
{
    Name = name ?? string.Empty
        ...
        [Test]
        public void Calculate_SingleInterfaceWithSingleMethod_ShouldReturn1()
        {
...
namespace SomeNamespace
{
    public interface ISomeInterface
    {
        ...
        [Test]
        public void Calculate_SingleAbstractClassWithSingleAbstractMethod_ShouldReturn1()
        {
            const string fileCode = @"using System;
